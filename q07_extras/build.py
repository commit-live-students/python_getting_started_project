...
def extras_runs(data=data):
    ...
    inning1 =[int(list(z)[0]['runs']['extras']) for z in deliveries if int(list(z)[0]['runs']['extras'])!=0]
    
    deliveries1 = [x.values() for x in data['innings'][0]['1st innings']['deliveries']]
    
    inning2 =[int(list(z)[0]['runs']['extras']) for z in deliveries1  if int(list(z)[0]['runs']['extras']) !=0]
